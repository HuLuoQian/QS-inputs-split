<template>
	<view>
		<QSPics ref="pics" name="pics" variableName="pics" title="上传图片" v-model="picsData"></QSPics>
...
<script>
	...
	export default {
		data() {
			return {
				picsData: [{title: '测试', required: true}, {title: '测试2', required: true}]
			}
		},
		methods: {
			getPics() {
