<template>
	<view>
		<block v-for="(item, index) in items" :key="index">
			...
			:color="item.color"
			:scale="item.scale"
			:itemDisabled="itemDisabled"></QSCheckbox>
		</block>
		<button type="primary" @tap="getForm()" style="margin-top: 50rpx;">获取数据</button>
		<button type="primary" @tap="setItemDisabled()" style="margin-top: 10rpx;">禁用</button>
	</view>
</template>
