<template>
	<view>
		<QSInfinitePics ref="infinitePics" name="infinitePics" variableName="infinitePics" title="上传图片" v-model="picsData"></QSInfinitePics>
		<QSInfinitePics ref="infinitePics_sort" name="infinitePics" variableName="infinitePics_sort" title="开启排序选择模式" sortSelection v-model="sortSelectionData"></QSInfinitePics>
...
<script>
	...
	export default {
		...
		methods: {
			...
			getForm() {
				QSApp.getForm('infinitePics').then(res=>{
